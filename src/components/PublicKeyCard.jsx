    ...
    return(
        ...
        >
            ...
            >
                ...
                <Box>
                    <Typography component="div" sx={{ fontSize: cardTitleSize, lineHeight: '1.2', mb: 1  }}>
                        {translate('contact.pgp.title')}
                    </Typography>
                    <Typography component="div" sx={{ fontSize: paragraphSize, lineHeight: '1.2'}}>
                        {translate('contact.pgp.subtitle')}
                    </Typography>
                    <Box sx={{ display: 'inline',  mr: 1 }}>
                        <DownloadButton fileName="okrim_public_key.asc" label={translate('contact.pgp.download')} /> 
                    </Box>
